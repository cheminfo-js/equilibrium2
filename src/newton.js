...
module.exports = function (matrixModel, equilibriumModel, totalCalcConcentration) {
    ...
    var jStar = jacobianStar(matrixModel, equilibriumModel, totalCalcConcentration);
    var inverseJacobianStar = mlMatrix.inverse(jStar);
...
function jacobianStar(matrixModel, equilibriumModel, VectorTotalConcentration) {
    var mlMatrix = require('ml-matrix');
    var Matrix = require('./util/matrix');
    var numberSpecies = equilibriumModel.species.length;
